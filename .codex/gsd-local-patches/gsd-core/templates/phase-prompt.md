...
<!-- For checkpoint task examples and patterns, see @D:/Repos/lancet/.codex/gsd-core/references/checkpoints.md -->
...
See `D:/Repos/lancet/.codex/gsd-core/references/tdd.md` for TDD plan structure.
...
See `D:/Repos/lancet/.codex/gsd-core/templates/user-setup.md` for full schema and examples
...
See `D:/Repos/lancet/.codex/gsd-core/workflows/verify-phase.md` for verification logic.
