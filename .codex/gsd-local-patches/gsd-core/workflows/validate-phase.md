...
```
Agent(
  prompt="Read D:/Repos/lancet/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Repos/lancet/.codex/gsd-core/templates/VALIDATION.md`
