...
- **Global scope**: `D:/Repos/lancet/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/Repos/lancet/.codex/notes/`)
...
2. Glob `D:/Repos/lancet/.codex/notes/*.md` (if directory exists) — global notes
...
Global (D:/Repos/lancet/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/Repos/lancet/.codex/notes/` — works in any directory
