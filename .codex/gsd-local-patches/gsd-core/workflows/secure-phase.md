...
```
Agent(
  prompt="Read D:/Repos/lancet/.codex/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Repos/lancet/.codex/gsd-core/templates/SECURITY.md`
