...
Key references:
- @D:/Repos/lancet/.codex/gsd-core/references/ui-brand.md (display patterns)
- @D:/Repos/lancet/.codex/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/Repos/lancet/.codex/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/Repos/lancet/.codex/gsd-core/USER-PROFILE.md"
...
```bash
cp "D:/Repos/lancet/.codex/gsd-core/USER-PROFILE.md" "D:/Repos/lancet/.codex/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/Repos/lancet/.codex/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/Repos/lancet/.codex/gsd-core/references/user-profiling.md`
...
Reference: @D:/Repos/lancet/.codex/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to D:/Repos/lancet/.codex/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global AGENTS.md" -- "Add profile to D:/Repos/lancet/.codex/AGENTS.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/Repos/lancet/.codex/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated $gsd-dev-preferences at D:/Repos/lancet/.codex/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to D:/Repos/lancet/.codex/AGENTS.md"
...
```bash
BACKUP_PATH="D:/Repos/lancet/.codex/USER-PROFILE.backup.md"
```
...
Your profile:    D:/Repos/lancet/.codex/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ $gsd-dev-preferences   D:/Repos/lancet/.codex/skills/gsd-dev-preferences/SKILL.md
  ✓ AGENTS.md section       <resolved claude_md_path, default ./.codex/AGENTS.md>
  ✓ Global AGENTS.md        D:/Repos/lancet/.codex/AGENTS.md
```
