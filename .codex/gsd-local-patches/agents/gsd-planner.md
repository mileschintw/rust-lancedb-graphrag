...
@C:/Users/user3/repos/lancet/.codex/gsd-core/references/mandatory-initial-read.md
...
**Project skills:** @C:/Users/user3/repos/lancet/.codex/gsd-core/references/project-skills-discovery.md
...
@C:/Users/user3/repos/lancet/.codex/gsd-core/references/planner-source-audit.md for full format, examples, and gap-handling rules.
...
@C:/Users/user3/repos/lancet/.codex/gsd-core/references/planner-source-audit.md for constraint examples.
...
See @C:/Users/user3/repos/lancet/.codex/gsd-core/references/planner-guidance.md for planning philosophy (Solo Developer workflow, Plans Are Prompts, Quality Degradation Curve, Ship Fast).
...
**<precondition>** (optional, one prose line): a runnable/checkable fact the task assumes that plan ordering does not guarantee — external setup (`user_setup`), a prior-phase artifact, or an env var. The executor asserts it before running the task and halts on unmet. Emission rules + the contract triad (precondition ↔ `<verify>`/`<done>` ↔ `must_haves.truths`): @C:/Users/user3/repos/lancet/.codex/gsd-core/references/planner-preconditions.md.

**<reversibility>** (optional): `rating="reversible|costly|one-way"` + one-line rationale for a decision this task implements. `one-way` inserts a `checkpoint:decision` before this task; `costly` is flagged only; unsure means `reversible`. Rules: @C:/Users/user3/repos/lancet/.codex/gsd-core/references/planner-reversibility.md

See @C:/Users/user3/repos/lancet/.codex/gsd-core/references/planner-guidance.md for Task Types table, Task Sizing rules, Interface-First Task Ordering, and Specificity guidance.

## TDD Detection

**When `workflow.tdd_mode` is enabled:** Apply TDD heuristics aggressively — all eligible tasks MUST use `type: tdd`. Read @C:/Users/user3/repos/lancet/.codex/gsd-core/references/tdd.md for gate enforcement rules and the end-of-phase review checkpoint format.
...
See @C:/Users/user3/repos/lancet/.codex/gsd-core/references/planner-guidance.md for User Setup Detection protocol (external service indicators, env vars, dashboard config).

</task_breakdown>

<dependency_graph>

See @C:/Users/user3/repos/lancet/.codex/gsd-core/references/planner-guidance.md for dependency graph building rules and file ownership for parallel execution.
...
<execution_context>
@C:/Users/user3/repos/lancet/.codex/gsd-core/workflows/execute-plan.md
@C:/Users/user3/repos/lancet/.codex/gsd-core/templates/summary.md
</execution_context>
...
See @C:/Users/user3/repos/lancet/.codex/gsd-core/references/planner-guidance.md for a worked example and the `must_haves` YAML format.
...
@C:/Users/user3/repos/lancet/.codex/gsd-core/references/planner-antipatterns.md
...
@C:/Users/user3/repos/lancet/.codex/gsd-core/references/thinking-models-planning.md
...
See @C:/Users/user3/repos/lancet/.codex/gsd-core/references/planner-guidance.md for `## PLANNING COMPLETE` and `## GAP CLOSURE PLANS CREATED` return format templates.

See @C:/Users/user3/repos/lancet/.codex/gsd-core/references/planner-chunked.md for `## OUTLINE COMPLETE` and `## PLAN COMPLETE` return formats used in chunked mode.
