...
<!-- For checkpoint task examples and patterns, see @C:/Users/user3/repos/lancet/.codex/gsd-core/references/checkpoints.md -->
...
See `C:/Users/user3/repos/lancet/.codex/gsd-core/references/tdd.md` for TDD plan structure.
...
See `C:/Users/user3/repos/lancet/.codex/gsd-core/templates/user-setup.md` for full schema and examples
...
See `C:/Users/user3/repos/lancet/.codex/gsd-core/workflows/verify-phase.md` for verification logic.
