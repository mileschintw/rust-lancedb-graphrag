...
<!-- For checkpoint task examples and patterns, see @D:/Repos/lancet/.cursor/gsd-core/references/checkpoints.md -->
...
See `D:/Repos/lancet/.cursor/gsd-core/references/tdd.md` for TDD plan structure.
...
See `D:/Repos/lancet/.cursor/gsd-core/templates/user-setup.md` for full schema and examples
