...
ones). Reference: @D:/Repos/lancet/.cursor/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / D:/Repos/lancet/.cursor.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "D:/Repos/lancet/.cursor/gsd-core/bin/lib/edge-probe.cjs" \
  "D:/Repos/lancet/.cursor/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @D:/Repos/lancet/.cursor/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @D:/Repos/lancet/.cursor/gsd-core/templates/spec.md.
