...
```markdown
Read D:/Repos/lancet/.cursor/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/Repos/lancet/.cursor/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/Repos/lancet/.cursor/agents/gsd-ui-checker.md for instructions.
...
@D:/Repos/lancet/.cursor/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / D:/Repos/lancet/.cursor.
...
UI_PROBE_JS=$(for _c in \
  ...
  "D:/Repos/lancet/.cursor/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "D:/Repos/lancet/.cursor/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
