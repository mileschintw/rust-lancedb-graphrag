...
```markdown
Read D:/Repos/lancet/.cursor/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/Repos/lancet/.cursor/gsd-core/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/Repos/lancet/.cursor/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/Repos/lancet/.cursor/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/Repos/lancet/.cursor/agents/gsd-eval-planner.md for instructions.
