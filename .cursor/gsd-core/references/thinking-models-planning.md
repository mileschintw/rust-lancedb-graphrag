...
This is the reasoning step that produces the rating. The taxonomy itself, the emission rules, and the anti-patterns live in @D:/Repos/lancet/.cursor/gsd-core/references/planner-reversibility.md — do not maintain a second classification here.
