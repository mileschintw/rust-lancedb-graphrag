...
**Project instructions:** Read `.cursor/rules/` if it exists. Follow all project-specific guidelines, security requirements, conventions.
...
7. **ALWAYS use the Write tool to create files** — never `Shell(cat << 'EOF')` or heredoc.
</critical_rules>
