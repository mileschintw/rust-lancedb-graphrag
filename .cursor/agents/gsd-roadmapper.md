...
`D:/Repos/lancet/.cursor/gsd-core/templates/roadmap.md` is the canonical shape.
...
Reference full template: `D:/Repos/lancet/.cursor/gsd-core/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Repos/lancet/.cursor/gsd-core/templates/state.md`.
