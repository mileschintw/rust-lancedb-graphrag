...
**Read and run** the gate + edge probe in `D:/Repos/lancet/.claude/gsd-core/references/specless-probe-fallback.md`
...
else-branch below, per §A/§B/§C of `D:/Repos/lancet/.claude/gsd-core/references/specless-probe-fallback.md`
