...
INSTALL_JS_GLOBAL="C:/Users/user3/repos/lancet/.claude/gsd-core/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/Users/user3/repos/lancet/.claude/gsd-core/bin/install.js --global --<runtime>
```
Then exit.
