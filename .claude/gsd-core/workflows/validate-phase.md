...
```
Agent(
  prompt="Read C:/Users/user3/repos/lancet/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/Users/user3/repos/lancet/.claude/gsd-core/templates/VALIDATION.md`
